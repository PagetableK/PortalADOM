            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="agregarModalLabel">Agregar áreal laboral</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formularioAgregar">
                            <div class="mb-3">
                                <label for="agregarAreaLaboral" class="form-label">Area laboral</label>
                                <input type="text" class="form-control" id="agregarAreaLaboral" required>
                            </div>
    ...
    modalContainer.innerHTML = `
        <div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editarModalLabel">Editar área laboral</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form id="formularioEditar">
                            <div class="mb-3">
                                <label for="editarAreaLaboral" class="form-label">Area laboral</label>
                                <input type="text" class="form-control" id="editarAreaLaboral" required>
                            </div>
                            <!-- Otros campos del formulario -->
                            <div class="mb-3">
